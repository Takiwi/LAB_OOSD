...
namespace QuanLyKhachSan.Forms {
  public partial class FrmDatPhong: Form {
    ...
    private void btnThemPhong_Click(object a, EventArgs e) {
      ...
      foreach(var x in chon) if (x.SoPhong == p) {
    ...
    private void btnBoPhong_Click(object a, EventArgs e) {
      if (dgvChon.CurrentRow != null && dgvChon.CurrentRow.Index >= 0 && dgvChon.CurrentRow.Index < chon.Count) chon.RemoveAt(dgvChon.CurrentRow.Index);
    }
